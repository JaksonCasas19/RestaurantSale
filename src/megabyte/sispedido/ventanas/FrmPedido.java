...
public class FrmPedido extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 360, 40, 40));
        ...
        jPrint.setText("jButton7");
        jPrint.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jPrintMouseClicked(evt);
            }
        });
        jPanel2.add(jPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 360, -1, 40));
...
// TODO add your handling code here:
        ...
        parameters.put("Nropedido", pedido.getIDPedido());
        parameters.put("FechaPedido", pedido.getFechaPedido());
        parameters.put("Cliente", pedido.getCliente().getNombre());
        parameters.put("Direccion", pedido.getCliente().getDireccion());
        parameters.put("Subtotal", pedido.getSubTotal());
        parameters.put("Igv", pedido.getIgv());
        parameters.put("Total", pedido.getTotal());
        //JAKSOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
        try {
            JasperPrint print = JasperFillManager.fillReport("reportes/NotaDePedido.jasper",
                    parameters, new JRBeanCollectionDataSource(pedido.getDetalleEnMap()));
            
            VisualizadorJasper.viewReport(print);
        } catch (Exception e) {
            e.printStackTrace();
